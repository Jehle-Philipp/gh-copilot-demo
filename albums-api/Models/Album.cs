namespace albums_api.Models
{
    public record Album(int Id, string Title, string Artist,int year, double Price, string Image_url)
    {
        public static List<Album> GetAll()
        {
            ...
            new Album(1, "You, Me and an App Id", "Daprize", 2024, 10.99, "https://aka.ms/albums-daprlogo"),
            new Album(2, "Seven Revision Army", "The Blue-Green Stripes", 2024, 13.99, "https://aka.ms/albums-containerappslogo"),
            new Album(3, "Scale It Up", "KEDA Club", 2024, 13.99, "https://aka.ms/albums-kedalogo"),
            new Album(4, "Lost in Translation", "MegaDNS", 2023, 12.99,"https://aka.ms/albums-envoylogo"),
            new Album(5, "Lock Down Your Love", "V is for VNET", 2022, 12.99, "https://aka.ms/albums-vnetlogo"),
